...
mysqldump slotoprizes --single-transaction -R -u admin --password=lani0363 -h slotoprizes.cdy8hosrrn6a.eu-west-3.rds.amazonaws.com > slotoprizes-local_$now.sql -vv
echo bzip2
