...
router.route('/reward_calendar').get(checkDeviceId, checkToken, checkmaintenanceMode, slot.rewardCalendarGet)
...
router.route('/cards_for_crud_chest').post(checkTokenForBO, slot.chestForFrontPost)
