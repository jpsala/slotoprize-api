...
export async function appodealCallback(data1?: string, data2?: string, queryParams?: QueryParams): Promise<void> {
  ...
  // const queryParams = queryParamsStr !== undefined
  // let queryParams: QueryParams | undefined = undefined
  // if(queryParamsStr) queryParams = JSON.parse(queryParamsStr)
  ...
  console.log('QueryParams', queryParams, queryParams['user_id'])
